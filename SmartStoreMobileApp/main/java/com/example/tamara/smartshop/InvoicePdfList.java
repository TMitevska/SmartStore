...
public class InvoicePdfList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shop_invoicepdf);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            createInvoiceList(task.getResult());
                        }
                    }
                });
    }
    ...
    private void createInvoiceList(QuerySnapshot documentList) {
        ...
        for (QueryDocumentSnapshot document : documentList) {
            ...
            invoice.setText("фактура_" + document.get("document_number") + ".pdf");
                            ...
                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        File file = new File("/storage/emulated/0/Download/faktura"+document.get("document_number")+".pdf");
                                        try {
                                            fakturaWriter = PdfWriter.getInstance(faktura, new FileOutputStream(file.getAbsoluteFile()));
                                        ...
                                        try {
                                            faktura.add(headerdata.createFakturaHeader(faktura, fs, 100));
                                        } catch (DocumentException e) {
                                            e.printStackTrace();
                                        }
                                        try {
                                            ...
                                            faktura.close();
                                            Toast.makeText(getApplicationContext(), "Преземање на фактура...", Toast.LENGTH_SHORT).show();
                                        } catch (DocumentException e) {
                                            e.printStackTrace();
                                        }
                                    }
