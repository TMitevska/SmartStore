...
public class remoteControlController {
    ...
    public String remoteControl(Map<String, Object> model, @RequestParam("userId") String userid,  @RequestParam("roleId") String role) {
        ...
        model.put("music", Translator.music);
        model.put("camera", Translator.camera);
        model.put("light", Translator.light);
        model.put("cameraStatus","true");
        model.put("musicStatus","true");
        model.put("lightStatus","true");
