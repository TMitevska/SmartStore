    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            setInterval(function(){
                $('#payslipTable tbody tr').not(':first').remove();
                loaddata();
            }, 60000);
        });
        function loaddata(){
                ...
                success: function (data) {
                    if(data){
                        $.each(JSON.parse(data), function (index, value) {
                            var res = value.split(":");
                            $('#payslipTable tbody tr:last').after("<tr id=\""+res[0]+"\"><td width='100' align=\"left\"><b>"+(index+1)+". </b></td><td align=\"left\" width='200'>"+res[1]+"</td><td width='250' align=\"left\">"+res[2]+"</td><td width='150' align=\"left\">"+res[3]+" </td><td width='150' align=\"left\"><a onclick=\"previewPayslip('"+res[0]+"')\" title=\"${preview}\"><img style=\"cursor:pointer\" src='preview.png' width='30' height='30' alt='img'></a><a onclick=\"printInvoice('"+res[0]+"')\" style=\"margin:0px 20px\" title=\"${download}\"><img style=\"cursor:pointer\" src='download.png' width='30' height='30' alt='img'></a><a onclick=\"deleteInvoice('"+res[0]+"')\" title=\"${delete}\" class=\"delete\"><img style=\"cursor:pointer\" src='delete.png' width='30' height='30' alt='img'></a></td></tr>");
                        });
                    }
                    ...
                    if(data){
                        ...
                        $.ajax({
                            ...
                            success: function (productdata) {
                                ...
                                $.ajax({
                                    url: "http://localhost:9090/downloadDocument",
                                    type: "POST",
            ...
            <div class="container">
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href='http://localhost:9090/payslipPdfList?userId=${userid}&roleId=${roleId}'><i class="fa fa-list" aria-hidden="true"></i> ${payslipList}</a></li>
            ...
            <div class="login-page">
                <div class="form ">
                    <form id="loginForm" class="login-form">
                        <img src="paysliplist.png" width="400" height="100" alt="img">
